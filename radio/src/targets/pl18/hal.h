...
// #define KEYS_GPIO_PIN_PGUP              /* for activating PGUP in keys diagnose screen */
  ...
  #define ADC_GPIO_PIN_SWE                LL_GPIO_PIN_1      // PC.00
...
// Power
#define PWR_SWITCH_GPIO             GPIO_PIN(GPIOD, 4)   // PI.11
#define PWR_ON_GPIO                 GPIO_PIN(GPIOD, 5)   // PI.14
...
#define USB_GPIO_DM                     GPIO_PIN(GPIOB, 14) // PA.11  ??
#define USB_GPIO_DP                     GPIO_PIN(GPIOB, 15) // PA.12   ??
#define USB_GPIO_AF                     GPIO_AF10

#if defined(RADIO_NV14_FAMILY) 
  #define USB_GPIO_VBUS                 GPIO_PIN(GPIOC, 5)  // PA.09   ??
...
#define BACKLIGHT_GPIO                  GPIO_PIN(GPIOD, 13) // PA.15  ??
...
#define ROTARY_ENCODER_TIMER_IRQHandler TIM8_UP_TIM13_IRQHandler
  ...
  #else
    #define SD_PRESENT_GPIO               GPIO_PIN(GPIOC, 5) // PH.10  ??
  #endif
...
#define FLASH_SPI_CS_GPIO              GPIO_PIN(GPIOG, 3)  // PG.06
#define FLASH_SPI_SCK_GPIO             GPIO_PIN(GPIOB, 3) // PG.13
#define FLASH_SPI_MISO_GPIO            GPIO_PIN(GPIOB, 4) // PG.12
#define FLASH_SPI_MOSI_GPIO            GPIO_PIN(GPIOB, 5) // PG.14
...
// LED Strip
  ...
  #define LED_STRIP_GPIO                    GPIO_PIN(GPIOG, 7)  // PH.12 / TIM5_CH3
...
#define TRAINER_OUT_GPIO                GPIO_PIN(GPIOD, 11) // PD.13
...
// Bluetooth
  ...
  #define BT_CMD_MODE_GPIO                GPIO_PIN(GPIOH, 5)  // PH.06    ??
#endif
